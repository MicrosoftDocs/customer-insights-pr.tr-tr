...
- **Segment dışa aktarmaları**, Customer Insights'tan segment varlıklarını dışa aktarabilmenize izin verir. Segmentler, müşteri profillerinin listesini temsil eder. Verme işlemini yapılandırırken, veri verdiğiniz hedef sisteme bağlı olarak eklenen veri alanlarını seçersiniz. 
