...
Kuruluşunuz Azure Synapse Analytics uygulamasının gelişmiş analiz özelliklerini zaten kullanıyorsa ve çıktıyı Data Lake veri tabanlarında depoluyorsa bu verileri kolayca Customer Insights'a alabilirsiniz. Daha fazla bilgi için bkz. [Azure Synapse veri kaynağı bağlama (Önizleme)](connect-synapse.md).
...
Veri hazırlama işlemi artık kolay tanımlama için bireysel kayıt düzeyinde bozulmuş veri içeren tüm alanlar için bozulmanın nedenini gösterir. 
